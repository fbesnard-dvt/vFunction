...
public class LocalizationDispatchingFilter implements Filter {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(LocalizationDispatchingFilter.class.getName());
        ...
        if (redirectString != null) {
            if ("true".equalsIgnoreCase(redirectString)) {
                ...
                throw new IllegalArgumentException(
                        "The value for the initial paramter '" + REDIRECT_PARAM
                                + "' is invalid");
            }
        }
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        LOGGER.log(Level.FINER, "The locale of the current client: " + locale.toString());
        ...
        if (null != locale.getCountry() && !"".equals(locale.getCountry())) {
            pathToLocalizedResource = "/start_"
                    + locale.getLanguage().toLowerCase() + "_"
                    + locale.getCountry().toUpperCase() + ".xhtml";
            if (filterConfig.getServletContext().getResource(
        ...
        if (pathToLocalizedResource == null) {
            pathToLocalizedResource = "/start_"
                    + locale.getLanguage().toLowerCase() + ".xhtml";
            if (filterConfig.getServletContext().getResource(
                    pathToLocalizedResource) == null) {
                pathToLocalizedResource = null;
            }
        ...
        if (pathToLocalizedResource == null) {
            ...
            if (redirect) {
                httpResponse.sendRedirect(httpRequest.getContextPath()
                        + pathToLocalizedResource);
            } else {
                filterConfig.getServletContext()
                        .getRequestDispatcher(pathToLocalizedResource)
