...
public class MethodInvocationCacheImplTestCase {
    ...
    public void setup() throws Exception {
        ...
        methodInvocationCache.addResult(String.class.getMethod("hashCode"),
                str.hashCode(), new Object[0]);
        methodInvocationCache.addResult(
                String.class.getMethod("startsWith", String.class),
                str.startsWith("a"), new Object[] { "a" });
    }

    @Test
    public void findResult() throws NoSuchMethodException {
        try {
            int hashCode = (Integer) methodInvocationCache.findResult(
                    String.class.getMethod("hashCode"), new Object[0]);
            assertEquals(str.hashCode(), hashCode);
        } catch (ResultNotCachedException e) {
            fail();
        }
        try {
            boolean result = (Boolean) methodInvocationCache.findResult(
                    String.class.getMethod("startsWith", String.class),
                    new Object[] { "a" });
    ...
    public void findNonexistingResult() throws NoSuchMethodException {
        try {
            methodInvocationCache.findResult(
                    String.class.getMethod("endsWith", String.class),
                    new Object[] { "a" });
            fail();
        } catch (ResultNotCachedException e) {
        }
    ...
    public void invalidateResultsByMethod() throws NoSuchMethodException {
        methodInvocationCache.invalidateResultsByMethod(String.class.getMethod(
    ...
    public void invalidateAllResults() throws NoSuchMethodException {
        ...
        try {
            methodInvocationCache.findResult(
                    String.class.getMethod("hashCode"), null);
            fail();
        } catch (ResultNotCachedException e) {
        }
