...
public class MethodParameterValidatorImplTestCase {
    ...
    public void validateObjectParameter() throws NoSuchMethodException {
        try {
            ...
            String message = "The number 1 parameter of type 'java.lang.Object' in method 'java.lang.String.equals()' is null";
    ...
    public void validatePrimitiveParameter() throws NoSuchMethodException {
        try {
            methodParameterValidator.validateParameters(
                    Object.class.getMethod("wait", Long.TYPE),
                    new Object[] { 0 });
        } catch (IllegalArgumentException e) {
            fail();
        }
    ...
    public void validateNullableParameter() throws NoSuchMethodException {
        try {
            methodParameterValidator.validateParameters(
                    Foo.class.getMethod("foo", String.class, String.class),
                    new Object[] { "", null });
        } catch (IllegalArgumentException e) {
            fail();
        }
