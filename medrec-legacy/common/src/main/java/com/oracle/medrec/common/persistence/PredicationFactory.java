...
public class PredicationFactory {
     ...
     * @return
     */
    public static final Predication<Object> createEqualPredication(
     ...
     * @return
     */
    public static final Predication<String> createLikePredication(String value,
            String... attribute) {
     ...
     */
    public static final Predication<String> createLikePredication(String value,
            SingularAttribute<Object, String>... attribute) {
        return new LikePredication(value, attribute);
    }
