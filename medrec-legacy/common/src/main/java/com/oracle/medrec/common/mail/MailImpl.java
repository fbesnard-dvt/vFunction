...
public class MailImpl implements Serializable, Mail {
    ...
    private static final long serialVersionUID = 19347859034L;
    ...
    public boolean equals(Object o) {
        ...
        final MailImpl mail = (MailImpl) o;

        if (content != null ? !content.equals(mail.content)
                : mail.content != null) {
            return false;
        }
        ...
        if (subject != null ? !subject.equals(mail.subject)
                : mail.subject != null) {
            return false;
        }
