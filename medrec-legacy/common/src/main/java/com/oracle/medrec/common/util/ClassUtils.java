...
public abstract class ClassUtils {
    ...
    public static Class getGenericArgumentType(Class currentClass,
        ...
        if (superType == null) {
            throw new IllegalArgumentException("Class '" + currentClass
                    + "' doesn't have correct generic super class");
        }
        ...
        Object[] args = ((ParameterizedType) superType)
    ...
    public static <T> T instantiateClass(Class<T> clazz) {
        try {
            ...
            throw new SystemException("Cannot instantiate class: "
                    + clazz.getName(), e);
    ...
    public static <T> T cast(Class<T> clazz, Object object) {
        ...
        throw new ClassCastException("Cannot cast class "
                + object.getClass().getName() + ", whose classloader is "
                + object.getClass().getClassLoader() + ", to class " + clazz
