...
public class CriteriaPersistenceSupport {
    ...
    private static <E> CriteriaQuery<E> query(CriteriaBuilder cb,
            Class<E> entityClass, Predication... predications) {
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    private static <E> CriteriaQuery<Long> queryCount(CriteriaBuilder cb,
            Class<E> entityClass, Predication... predications) {
    ...
    public static <E> List<E> find(EntityManager entityManager,
            CriteriaBuilder cb, Class<E> entityClass,
    ...
    @SuppressWarnings({ "rawtypes" })
    public static <E> List<E> find(EntityManager entityManager,
            CriteriaBuilder cb, Class<E> entityClass, int offset, int limit,
            Predication... predications) {
        try {
            CriteriaQuery<E> cq = query(cb, entityClass, predications);
            return entityManager.createQuery(cq).setFirstResult(offset)
     ...
     */
    @SuppressWarnings({ "rawtypes" })
    public static <E> E findUnique(EntityManager entityManager,
            CriteriaBuilder cb, Class<E> entityClass,
            Predication... predications) {
        try {
            CriteriaQuery<E> cq = query(cb, entityClass, predications);
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public static int count(EntityManager entityManager, CriteriaBuilder cb,
            Class entityClass, Predication... predications) {
        try {
