...
import com.oracle.medrec.common.web.Constants;
...
public class SearchingPatientController extends BasePhysicianPageController {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(SearchingPatientController.class.getName());
    ...
    public List<FoundPatient> getPatients() {
        if (patients == null) {
            ...
            patients = (List<FoundPatient>) getPageContext().getSessionMap()
                    .get(Constants.PATIENTS_SESSION_KEY);
        }
        return patients;
    }
    ...
    public void search() {
        ...
        LOGGER.log(Level.FINER, "Searching patients... last name: " + lastName
                + ", ssn: " + ssn);
        if (ssn == null) {
            ssn = "";
        }
        ...
        getPageContext().getSessionMap().put(Constants.PATIENTS_SESSION_KEY,
                patients);
    }
